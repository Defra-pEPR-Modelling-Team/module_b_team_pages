...
The first time you login to AWS, there is some initial set up to do - you only need to do this once: 

1. Go to the [AWS console](https://int-sce-network.awsapps.com/console)

2. Log in using existing credentials

3. You are now in the LOGIN account. You need to switch role to the RANCH account using the menu in the top right corner of the page (official docs)

4. Ranch account number: 172974337612 

5. Role name is ExtendedProducerResponsibility

6. Display name can be anything you like

7. Once logged in, remember to set the region to Ireland (AKA eu-west-1)
...
**All binned waste data** should be stored in the appropriate B1 or B2 folder at: *s3://s3-ranch-043/Module_B1/* or *s3://s3-ranch-043/Module_B2/*.
