...
If the changes made involve adding, removing or changing an assumption, data import or code logic, then the modelling team member must update the relevant assumption log, data log and/or the technical document, code comments and roxygen headers.

If the changes result in a functional change to the model, i.e. the changes will effect model outputs, then valdation checks must be carried out.
...
>
> <h4 id="how_to_validate">
>
> <b>How to run validation checks</b>
>
> </h4>
> 
...
>    Use the spreadsheet "[model_version] model output sensitivity testing.xlsx" on the Module B1 Sharepoint, within 00 Model Master > [model_version]
