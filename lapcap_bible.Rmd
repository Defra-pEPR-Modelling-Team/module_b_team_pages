...
A modelling team member makes changes to code

Through R Studio and Github changes are made to the existing LAPCAP model. This will be achieved through standard Git practice, e.g. branching off from the dev branch.
...
### A different modelling team member verifies their changes
...
Approved changes are merged into dev branch
...
### SRO & pEPR Project Board signoff
