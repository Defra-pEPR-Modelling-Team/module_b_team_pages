...
-   To **verify** the model is error free:
    ...
    -   In terms of verification this includes:

        -   

-   To **validate** the outputs of the model:

    -   

-   To make our analysis simple to **understand** and **communicate**:

    -   a log of data version, data quality assessment and processing done to the data. 
