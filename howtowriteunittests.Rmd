...
b.	Apply the dput function to your downsized datasets, to get an output in the command line that can be turned into a dummy dataset with all the required formats.
