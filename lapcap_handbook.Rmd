...
3.  If you are merging a new **tagged version** of the model...
    ...
    After merging you can then tag the commit on dev with the new model version using GitHub's tagging feature. If publishing externally and updating the first number in the model version, you should now open a PR and merge dev into main.
